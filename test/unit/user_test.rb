...
class UserTest < ActiveSupport::TestCase
  ...
  test "find_for_github_oauth updates existing user params" do
    user  = users(:mockstar)
    ...
    user = User.find_for_github_oauth oauth
  ...
  test "find_for_github_oauth creates new user user when user does not exist and oauth contains email" do
    oauth = OmniAuth::AuthHash.new(
  ...
  test "find_for_github_oauth creates new user user when user does not exist and oauth does not contains email" do
    oauth = OmniAuth::AuthHash.new(
